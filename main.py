...
def train(model, batch_size, epochs, num_workers, criterion, optimizer):
    ...
    trainloader = DataLoader(
        train_dataset, batch_size, shuffle=True, pin_memory=True, num_workers=num_workers
    )
    validloader = DataLoader(
        valid_dataset, batch_size, shuffle=False, pin_memory=True, num_workers=num_workers
    )
...
def save_checkpoint(model):
    ...
    checkpoint = {"input_size": 1, "output_size": 120, "state_dict": model.state_dict()}
